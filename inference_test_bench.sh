...
MODEL_DIR="models/MObI/2024-07-14T00-00-42_nusc_control_multimodal/checkpoints"
RUN_NAME="2024-07-14T00-00-42_nusc_control_multimodal"
...
for MODEL_PATH in ${MODEL_DIR}/*.ckpt; do
    ...
    for REF_TYPE in "same-ref" "track-ref"; do
